...
st.set_page_config(
    page_title="📊 Survey Evaluasi Tingkat Kepuasan Mahasiswa Terhadap Layanan Mahasiswa",
    layout="wide",
...
st.markdown("""
    <h2 style="text-align: center;">📊 Survey Evaluasi Tingkat Kepuasan Mahasiswa Terhadap Layanan Mahasiswa</h2>
